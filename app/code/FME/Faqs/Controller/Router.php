...
class Router implements \Magento\Framework\App\RouterInterface
{
    ...
    public function __construct(
        ...
        \FME\Faqs\Model\TopicFactory $topicFactory,
        \FME\Faqs\Model\FaqsFactory $faqsFactory,    
    ...
    public function match(\Magento\Framework\App\RequestInterface $request)
    {
        ...
        if ($faqId) {
            ...
            $request->setModuleName('faqs')->setControllerName('index')->setActionName('faq')->setParam('id', $faqId);
            $request->setAlias(\Magento\Framework\Url::REWRITE_REQUEST_PATH_ALIAS, $identifier);
            return $this->actionFactory->create('Magento\Framework\App\Action\Forward');            
        }
        ...
        $request->setModuleName('faqs')->setControllerName('index')->setActionName('detail')->setParam('topic', $topicId);
        $request->setAlias(\Magento\Framework\Url::REWRITE_REQUEST_PATH_ALIAS, $identifier);
        return $this->actionFactory->create('Magento\Framework\App\Action\Forward');        
    }
}
