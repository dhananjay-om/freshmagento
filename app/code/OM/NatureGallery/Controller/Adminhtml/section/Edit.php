...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Om_NatureGallery::Section')
            ->addBreadcrumb(__('Om NatureGallery'), __('Om NatureGallery'))
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Om\NatureGallery\Model\Section');
        ...
        $this->_coreRegistry->register('section', $model);
