...
namespace Om\NatureGallery\Block\Adminhtml\Content\Edit\Tab;

/**
 * Content edit form main tab
 */
class Main extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    {
        /* @var $model \Om\NatureGallery\Model\BlogPosts */
        $model = $this->_coreRegistry->registry('content');
